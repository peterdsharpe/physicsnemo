...
# Regional Weather Diffusion: High-Resolution Weather Models using Generative Diffusion
...
2. Copy this folder (`examples/weather/regional_weather_diffusion`) to a system with a GPU available. 
