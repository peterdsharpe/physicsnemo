...
Typical use from the repository root::
    ...
    python examples/cfd/laplace_mesh_transformer/study.py commands \
        --phase early --execute
    python examples/cfd/laplace_mesh_transformer/study.py commands \
        --phase finalists --finalist factorial_encoded_pair --finalist stf_l4 \
        --execute
    python examples/cfd/laplace_mesh_transformer/study.py aggregate \
        --phase finalists
...
DEFAULT_OUTPUT_ROOT = Path("outputs/laplace_mesh_transformer/study")
