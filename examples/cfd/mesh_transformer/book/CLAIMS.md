...
- **CAP VERDICT (2026-09-17; results/cap_reduction_2026-09-17.json; #sec-nb-cap-verdict).** One-car OVERFIT-1 instrument (constant gauge, seed 42, fp32 @10k on the training car; baseline 0.1064, Transolver 0.0811, GT 0.0766). Slices 128/512/1024: 0.1058/0.1096/0.1052 = NULL (slice hypothesis FALSIFIED; write "the slice count is not the bottleneck"). Depth 24: 0.1081 NULL. MLP ratio 8: 0.1019 NULL by bar (-4.2%). Width 384 (lr 5e-4): 0.0948 = CARRIES (-10.9%), does NOT close (1.17x Transolver); tail-20 loss 0.0002 vs 0.0004 (only arm in the baselines' fit band); at 40k cells 0.0806 ~ parity with T 0.0793 / GT 0.0780. Confound: width arm at 5e-4 vs baseline 1e-3 -> SHAPE control (ctrl_lr5e4) decides; until then write "width carries, rate component unbounded". Never write "more slices help" or "deeper helps".
