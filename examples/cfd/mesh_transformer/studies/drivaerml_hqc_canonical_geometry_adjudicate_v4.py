...
schema-v4 decision gates and outcome. Exactness is recomputed from contiguous
...
EXPECTED_DIAGNOSTIC_SCRIPT_SHA256 = (
    "c890271eee04efddd43e979b8bb5cb693209a192a3901ceee149c829d9dc4100"
)
...
EXPECTED_BUNDLE_MEMBER_SHA256_BY_BASENAME = {
    "drivaerml_hqc_canonical_geometry_diagnostic_v4.py": (
        EXPECTED_DIAGNOSTIC_SCRIPT_SHA256
    ),
    "drivaerml_trace_fixed_query_audit.py": EXPECTED_PRODUCER_SHA256,
    "phase1_hqc_neutral_canonical_geometry_preregistration_v4_2026-07-28.json": (
        "a7b3bd0cddf6e97f15dd8045911068528c4201a2a2fcddd8e3f44429cd57cbfe"
    ),
    "drivaerml_hqc_neutral_canonical_geometry_v4_aga.sbatch": (
        "6dde8a7fb780641e1c0a9131c252f17e2a10e5733e0d4951330e4c26d8060182"
    ),
    "drivaerml_hqc_neutral_canonical_geometry_v4_aga_README.md": (
        "bac08e3d0062d558561b73ae04237e99cbda70c73e6672551dfebbfbc73b0fe8"
    ),
    "phase1_hqc_neutral_canonical_geometry_launch_manifest_v4_2026-07-28.json": (
        "4af8adbd37a1123b569f7a5464395e5e5151e986f236b24dd1cfdaecd5603dea"
    ),
...
def adjudicate(
    *,
    ...
    _require(
        ...
        "Diagnostic NPZ key set differs from schema v4",
    )
