...
schema-v3 decision gates and outcome. Exactness is recomputed from contiguous
...
EXPECTED_DIAGNOSTIC_SCRIPT_SHA256 = (
    "eeb13eceb9cd080f88e259f93581671e7cf201057492969a327da8f0ae863840"
)
...
EXPECTED_BUNDLE_MEMBER_SHA256_BY_BASENAME = {
    "drivaerml_hqc_canonical_geometry_diagnostic_v3.py": (
        EXPECTED_DIAGNOSTIC_SCRIPT_SHA256
    ),
    ...
    "phase1_hqc_neutral_canonical_geometry_preregistration_v3_2026-07-28.json": (
        "6ca385f55c0f662b32933378ac271f168405be72817f80b4a14f4322caa14bcf"
    ),
    "drivaerml_hqc_neutral_canonical_geometry_v3_aga.sbatch": (
        "a059b5adce773d2988b3ed3c3559c48b0c0d2d83569cdaa4d4f53485f02a5e49"
    ),
    "drivaerml_hqc_neutral_canonical_geometry_v3_aga_README.md": (
        "ff8d413671303843aa890d1300e34e4a389f0736c135a1fc4d8469be501f0e6c"
    ),
    "phase1_hqc_neutral_canonical_geometry_launch_manifest_v3_2026-07-28.json": (
        "318506ba30c8ce35892fb91d77fcbf9586233a77f9794c76df1ed7634f3c8cbe"
    ),
...
def adjudicate(
    *,
    ...
    _require(
        ...
        "Diagnostic NPZ key set differs from schema v3",
    )
